...
<body class="bg-light">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link me-3 fw-bold" aria-current="page" href="index.php">Home</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active me-3 fw-bold" href="about.php">About</a>
          </li>
          <!--<li class="nav-item">
  ...
  <div class="container my-5  mb-5"
    style="background-image: url('img/csm-bg.jpg'); background-size: cover; background-position: center;">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-4 my-3">
        <!--  <img src="img/sir_baddy.jpg" class="bd-placeholder-img rounded-circle mx-auto d-block" width="340" height="305"
          alt="your image description"> -->
        <div class="my-5 px-4">
          <div class="h1 fw-bold text-center">Ryan Jonathan A. Torres</div>
          <p class="text-center">Client (Laboratory Technician)</p>
  ...
  <div class="container py-5">
    <div class="row featurette">
      ...
      <div class="col-md-5 my-auto">
        <img src="img/csmlogo.png" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
          alt="your image description">
      </div>
    </div>
  </div>
  ...
  <div class="container" style="margin-top:7rem;">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 my-3 text-center">
        <img id="profile-pic" src="img/absar.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
        <h2 class="fw-normal mt-3"><b>ABSAR U. MOHAMMAD</b></h2>
        <p class="text-center">Frontend Developer</p>
        <p class="text-center"><a href="https://www.facebook.com/absar.mohammad"><i
              class="fa-brands fa-facebook fa-2xl"></i></a></p>
      </div><!-- /.col-lg-4 -->

      <div class="col-lg-6 my-3 text-center">
        <img src="img/reuel.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
        <h2 class="fw-normal mt-3"><b>REUEL S. MENDOZA</b></h2>
        <p class="text-center">Backend Developer</p>
        <p class="text-center"><a href="https://www.facebook.com/Gordsssssssssssssssss"><i
              class="fa-brands fa-facebook fa-2xl"></i></a></p>
      </div><!-- /.col-lg-4 -->

      <div class="col-lg-6 my-3 text-center">
        <img src="img/tarras.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
        <h2 class="fw-normal mt-3"><b>JOMARI TARRAS</b></h2>
        <p class="text-center">System Analyst/Archivist</p>
        <p class="text-center"><a href="https://www.facebook.com/jomari.tacujantaras"><i
              class="fa-brands fa-facebook fa-2xl"></i></a></p>
      </div><!-- /.col-lg-4 -->

      <div class="col-lg-6 my-3 text-center">
        <img src="img/kelly.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
  ...
  <div class="container" style="margin-top:15rem;margin-bottom:7rem;">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 my-3 text-center">
        <img src="img/sam.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
        <h2 class="fw-normal mt-3"><b>AHMAD M. SALASAIN</b></h2>
        <p class="text-center">Frontend Developer</p>
        <p class="text-center"><a href="https://www.facebook.com/sam.cena.902604"><i
              class="fa-brands fa-facebook fa-2xl"></i></a></p>
      </div><!-- /.col-lg-4 -->

      <div class="col-lg-6 my-3 text-center">
        <img src="img/tan.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
        <h2 class="fw-normal mt-3"><b>KLARENE HILARY TAN</b></h2>
        <p class="text-center">Business Analyst</p>
        <p class="text-center"><a href="https://www.facebook.com/RaeRa.KimTan"><i
              class="fa-brands fa-facebook fa-2xl"></i></a></p>
      </div><!-- /.col-lg-4 -->

      <div class="col-lg-6 my-3 text-center">
        <img src="img/daryl.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
        <h2 class="fw-normal mt-3"><b>DARRYL FRANCISCO</b></h2>
        <p class="text-center">Backend Developer</p>
        <p class="text-center"><a href="https://www.facebook.com/darrygil.francisco"><i
              class="fa-brands fa-facebook fa-2xl"></i></a></p>
      </div><!-- /.col-lg-4 -->

      <div class="col-lg-6 my-3 text-center">
        <img src="img/realyn.jpg" class="rounded-circle mx-auto d-block" width="280" height="260"
          alt="your image description">
        <h2 class="fw-normal mt-3"><b>REALYN LUMIGAN</b></h2>
        <p class="text-center">Project Manager</p>
        <p class="text-center"><a href="https://www.facebook.com/realyn.lumigan"><i
              class="fa-brands fa-facebook fa-2xl"></i></a></p>
      </div><!-- /.col-lg-4 -->
  ...
  <div class="container" style="margin-top:16rem;margin-bottom:7rem;">
    <div class="row">
      ...
      <div class="col-lg-12 my-3 text-center">
        ...
        <p class="text-center"><a href="https://www.facebook.com/jason.catadman"><i
              class="fa-brands fa-facebook fa-2xl"></i></a></p>
      </div><!-- /.col-lg-4 -->
      ...
      <div class="modal-content">
        <form id="login-form" method="POST">
          <div class="modal-header">
            <h5 class="modal-title d-flex align-items-center"><i class="bi bi-person-check-fill fs-3 me-2"></i>User
              login</h5>
          ...
          <div class="modal-body">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-success " style="margin-right:120px;" data-bs-toggle="modal"
                data-bs-target="#registerModal">Create New Account</button>
            </div>
  ...
  <!---Forgot modal -->
  <div class="modal fade" id="forgotModal" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form id="forgot-form">
          <div class="modal-header">
            <h5 class="modal-title d-flex align-items-center"><i class="bi bi-shield-exclamation"></i> Forgot Password
            </h5>
            <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
  ...
  <div class="modal fade" id="recoveryModal" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title d-flex align-items-center"><i
                class="bi bi-person-plus-fill fs-3 me-2"></i></i>Student Registration</h5>
            <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
