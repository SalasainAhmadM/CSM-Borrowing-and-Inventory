            ...
            <form action="charge.php" id="booking_form" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input name="email" type="text" value="<?php echo $user_data['student_id'] ?>"
                    class="form-control shadow-none" required>
                </div>
                ...
                <div class="col-12">
                  ...
                  <button name="pay_now" type="submit" class="btn btn-success w-100 text-white shadow-none mb-1"
                    disabled>Borrowing Now</button>
                </div>
              </div>
            </form>
          </div>
