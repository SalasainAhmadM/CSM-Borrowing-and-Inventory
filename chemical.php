...
<body class="bg-light">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active me-3 fw-bold" href="chemical.php">Chemical</a>
          </li>
          <li class="nav-item">
  ...
  <div class="my-5 px-4">
    <div class="h2 fw-bold text-center">Our Chemical</div>
  ...
  <div class="container">
    <div class="text-end mb-4">
      <input type="text" oninput="search_chemical(this.value)" class="form-control shadow-none w-25 ms-auto"
        placeholder="Type to search..">
    </div>
    <div class="row" id="chemical-data">
