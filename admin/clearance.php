...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/mammoth/1.6.0/mammoth.browser.min.js"></script>
    <script>
        // Export to Word using mammoth.js
        function exportToWord() {
            var html = document.getElementById('clearance_data').outerHTML;

            mammoth.convertToHtml({ value: html })
                .then(function (result) {
                    var blob = new Blob([result.value], { type: "application/msword" });
                    var url = URL.createObjectURL(blob);
                    var a = document.createElement('a');
                    a.href = url;
                    a.download = 'clearance.docx';
                    a.click();
                })
                .catch(function (error) {
                    console.log("Error during Word export:", error);
                });
        }
        ...
        function exportToExcel() {
            var wb = XLSX.utils.table_to_book(document.getElementById('clearance_data'));
            XLSX.writeFile(wb, 'clearance.xlsx');
        }

        // Export to PDF using jsPDF
        function exportToPDF() {
            var pdf = new jsPDF();
            pdf.autoTable({ html: '#clearance_data' });
...
<body>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body mb-4">
                ...
                <div class="text-end my-2">
                    <!--      <button type="button" class="btn btn-success btn-sm shadow-none mb-2 me-2 ms-0" onclick="exportToE
                 x  cel()">
    ...
    <div class="modal fade" id="add-clearance" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
    ...
    <div class="modal fade" id="edit-clearance" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
