...
<head>
  ...
  <title>CSM - Confirm Barrowing</title>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 my-5 mb-4 px-4">
        <div class="h2 fw-bold text-center">Confirm Borrowing</div>
      ...
      <div class="col-12 my-7 mb-4 px-7">
            ...
            <form action="charge_chemical.php" id="booking_form" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input name="email" type="email" value="<?php echo $user_data['student_id'] ?>"
                    class="form-control shadow-none" required>
                </div>
                <div class="col-md-2 mb-3">
                  <label class="form-label mb-1">Course</label>
                  <input type="text" class="form-control shadow-none" value="<?php echo $user_data['course'] ?>" required
                    name="course">
                </div>
                <div class="col-md-1  mb-3">
                  <label class="form-label mb-1">Year</label>
                  <input type="text" class="form-control shadow-none" value="<?php echo $user_data['year'] ?>" required
                    name="year">
                </div>
                <div class="col-md-2 mb-3">
                  <div class="row">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="datetime-local" onchange="check_availability()" class="form-control shadow-none" required
                    name="checkin">
                </div>
                ...
                <div class="col-12">
                  ...
                  <h6 class="text-center fw-bold text-danger" id="pay_info">Please Provide Date and time first before
                    borrowing </h6>
                  ...
                  <button name="pay_now_chemical" type="submit"
                    class="btn btn-success w-100 text-white shadow-none mb-1" disabled>Borrowing Now</button>
                </div>
              </div>
            </form>
          </div>
        ...
        <form id="login-form" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="mb-2 text-center text-decoration-none">
              <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#forgotModal">Forgot
                Password?</a>
            </div>
  ...
  <div class="modal fade" id="registerModal" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
      <form id="register-form" method="POST">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title d-flex align-items-center"><i class="bi bi-person-plus-fill fs-3 me-2"></i></i>User
              Registration</h5>
            <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
